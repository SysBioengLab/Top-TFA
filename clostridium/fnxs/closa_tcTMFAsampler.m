function closa_tcTMFAsampler(model,bounds,volProp,name,options)
...
if (nargin<5)
    ...
    else sample.discreteFactor = 1000; end
...
%     t0 = cputime;
    ...
    matrix_struct = closa_createSamplingMatrix(model,bounds(:,:,i));
    % Homogenize system
    ...
    sample = buildProbParams(model,sample);
